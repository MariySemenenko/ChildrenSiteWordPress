                    ...
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item">
                                ...
                                <a href="mailto:svitIgrashok@gmail.com" class="header__contacts-mail"><?php the_field('mail', 2); ?></a>
                            </div>
                            <div class="header__contacts-item">
                                ...
                                <div class="header__contacts-tel">
                                    ...
                                    <a href="tel:+0000000001"><?php the_field('phone', 2); ?></a>
                                </div>
                            </div>
                            <div class="header__contacts-item">
...
wp_nav_menu( [
	...
	'depth'           => 1     //рівень вкладеності на сайті
...
<!-- 
                    ...
                    <ul class="header__nav">
                        ...
                        <li>
                            <a class="header__nav-item" href="#aboutus">Наша істория</a>
                        </li>
                        <li>
