<div class="question">
            <div class="question__text">
                Якщо маєте запитання, то звертайтесь
            </div>
...
echo do_shortcode('[contact-form-7 id="f0cb825" title="Вспливаюча форма"]')
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="tel:+0000000000"><?php the_field('phone', 2); ?></a>
                                    <a href="tel:+0000000000"><?php the_field('secondphone', 2); ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCDIUd4P_2U8UvwFVNlOoO7BA80tOLOxKo&callback=Function.prototype"></script>
